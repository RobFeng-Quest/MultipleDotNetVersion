...
using Writer.Presentation;

namespace MultipleDotNetFramewrokProjectSample
{
    public partial class App : Application
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            catalog.Catalogs.Add(new AssemblyCatalog(typeof(PresentationController).Assembly));
        ...
        private static void HandleException(Exception e, bool isTerminating)
        {
            ...
            if (!isTerminating)
            {
                ...
                //        Writer.Presentation.Properties.Resources.UnknownError, e.ToString())
